...
app.get("/", (_req, res) => {
  res.json({
    ...
    docs: {
      ...
      adminSalesReps: "GET/POST/PATCH /api/admin/sales-reps",
      adminSalesRepDeactivate: "POST /api/admin/sales-reps/:salesRepId/deactivate",
      adminSalesRepReactivate: "POST /api/admin/sales-reps/:salesRepId/reactivate",
      adminCustomers: "GET /api/admin/customers",
      adminBulkAssignCustomers: "POST /api/admin/customers/assign-bulk",
